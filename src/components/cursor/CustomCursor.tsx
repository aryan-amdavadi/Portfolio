...
export const CustomCursor: React.FC<TargetCursorProps> = ({
  ...
  cursorColorOnTarget = 'var(--accent-base)'
}) => {
  ...
  useEffect(() => {
    ...
    const enterHandler = (e: MouseEvent) => {
      ...
      const cursorStateStr = target.getAttribute('data-cursor') || '';
      let newText = '';
      if (cursorStateStr === 'explore') newText = 'EXPLORE';
      else if (cursorStateStr === 'view') newText = 'VIEW';
      else if (cursorStateStr === 'open') newText = 'OPEN';
      else if (cursorStateStr === 'inspect') newText = 'INSPECT';
  ...
  return createPortal(
    <div ref={cursorRef} className="target-cursor-wrapper">
      ...
      <div ref={textRef} className={`target-cursor-text ${cursorText ? 'visible' : ''}`} style={{ color: cursorColor }}>
        {cursorText}
      </div>
